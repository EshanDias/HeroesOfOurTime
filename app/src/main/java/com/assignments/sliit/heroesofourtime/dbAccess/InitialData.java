...
class InitialData {
    ...
    protected List<Hero> getHeroes() {
        ...
        hero.setHeroImage(myContext.getDrawable(R.drawable.nelson_mandela_1918_2013_300x294));
        ...
        hero.setHeroImage(myContext.getDrawable(R.drawable.stephen_hawking_1942_present_300x200));
        hero.setCreatedDate(Calendar.getInstance().getTime());
        hero.setModifiedDate(Calendar.getInstance().getTime());
