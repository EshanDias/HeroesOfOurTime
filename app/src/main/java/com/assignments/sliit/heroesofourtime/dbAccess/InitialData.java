...
public class InitialData {
    ...
    public List<Hero> getHeroes() {
        ...
        hero.setHeroImage(myContext.getDrawable(R.drawable.nelson_mandela));
...
//        cal.set(2013,12,5);
        ...
        hero.setHeroImage(myContext.getDrawable(R.drawable.abdul_kalam));
        hero.setCreatedDate(Calendar.getInstance().getTime());
        hero.setModifiedDate(Calendar.getInstance().getTime());
        ...
        hero.setHeroImage(myContext.getDrawable(R.drawable.steve_jobs));
        hero.setCreatedDate(Calendar.getInstance().getTime());
        hero.setModifiedDate(Calendar.getInstance().getTime());
        ...
        hero.setHeroImage(myContext.getDrawable(R.drawable.oprah_winfrey));
        hero.setCreatedDate(Calendar.getInstance().getTime());
        hero.setModifiedDate(Calendar.getInstance().getTime());
        ...
        hero.setHeroImage(myContext.getDrawable(R.drawable.bill_gates));
        hero.setCreatedDate(Calendar.getInstance().getTime());
        hero.setModifiedDate(Calendar.getInstance().getTime());
        ...
        hero.setHeroImage(myContext.getDrawable(R.drawable.pele));
        hero.setCreatedDate(Calendar.getInstance().getTime());
        hero.setModifiedDate(Calendar.getInstance().getTime());
        ...
        hero.setHeroImage(myContext.getDrawable(R.drawable.angela_merkel));
        hero.setCreatedDate(Calendar.getInstance().getTime());
        hero.setModifiedDate(Calendar.getInstance().getTime());
